/*
 * @(#)ColorControlAdapter.java	1.3 08/09/15
 * 
 ...
 * player.
 */
public class ColorControlAdapter extends AtomicControlAdapter implements
	ColorControl {
    ...
    public ColorControlAdapter(NumericControl b, NumericControl c,
	    NumericControl s, NumericControl h, BooleanControl g, View comp,
	    boolean def, Control parent) {
