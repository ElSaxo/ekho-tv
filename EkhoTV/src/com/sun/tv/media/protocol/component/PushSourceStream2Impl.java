/*
 * @(#)PushSourceStream2Impl.java	1.7 08/09/15
 * 
 ...
 * obtained by means of <code>javax.media.Manager.createDataSource()</code>. If
 * access to broadcast asynchronous data is not supported by the system, this
