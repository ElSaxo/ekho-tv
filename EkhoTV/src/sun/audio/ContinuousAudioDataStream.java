/*
 * @(#)ContinuousAudioDataStream.java	1.3 08/09/15
 * 
...
/**
 * Create a continuous audio stream. This wraps a stream around an AudioData
 * object, the stream is restarted at the beginning everytime the end is
 * reached, thus creating continuous sound.
 * <p>
 * For example:
 * 
 * <pre>
